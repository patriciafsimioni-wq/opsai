...
export const metadata = {
  title: "LiveFleet AI — User Guide",
  description: "Complete user guide for LiveFleet AI fleet management platform",
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div>
            <h1 className="text-lg font-bold text-slate-800">LiveFleet AI</h1>
      ...
      <div className="mx-auto flex max-w-6xl gap-8 px-6 py-8">
        ...
        <main className="min-w-0 flex-1 space-y-10">
          ...
          <div className="rounded-xl bg-blue-600 p-8 text-white">
            <h1 className="text-2xl font-bold">Welcome to LiveFleet AI</h1>
          ...
          <Section id="getting-started" title="Getting Started">
            <SubSection title="Logging In">
              <ol className="ml-4 list-decimal space-y-1">
                <li>Open your browser and navigate to the LiveFleet AI URL</li>
          ...
          <Section id="pwa" title="Mobile App (PWA)">
            <p>LiveFleet AI works as a Progressive Web App:</p>
            <ul>
            ...
            <p>It appears as &quot;LiveFleet&quot; on your home screen and opens full-screen. Mobile hamburger menu available for navigation.</p>
          </Section>
