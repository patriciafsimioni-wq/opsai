...
export const IS_SYNCTX = BRAND.toUpperCase() === "SYNCTX";
...
// DOT / FMCSA driver-file requirements for Box Truck & Tractor Truck drivers.
...
export const DOT_STATE = IS_TROVA
  ...
  : { code: "TX", name: "Texas", agency: "Texas DPS / Texas DMV (Motor Carrier)" };
