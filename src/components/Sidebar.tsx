...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/rental-vehicles", label: "Rental Vehicles", icon: Car, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "DATA_ENTRY"] },
      { href: "/drivers", label: "Drivers", icon: Users, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "DATA_ENTRY"] },
      { href: "/dot-compliance", label: "DOT Compliance", icon: ShieldCheck, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "DATA_ENTRY"] },
      { href: "/fuel", label: "Fuel", icon: Fuel, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "DATA_ENTRY"] },
      { href: "/fareye-routes", label: "FareEye Routes", icon: Navigation, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "DATA_ENTRY"] },
      { href: "/offboarding", label: "Offboarding", icon: LogOut, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "DATA_ENTRY"] },
    ],
  },
  {
    title: "Maintenance",
  ...
  {
    title: "Finance",
    roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "DATA_ENTRY"],
    items: [
  ...
  {
    title: "Reports & Tools",
    roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "MECHANIC", "VENDOR", "DATA_ENTRY"],
    items: [
      { href: "/reports", label: "Reports", icon: BarChart3, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "MECHANIC", "DATA_ENTRY"] },
      { href: "/uploads", label: "Smart Upload", icon: Upload, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "DATA_ENTRY"] },
      { href: "/alerts", label: "Alerts", icon: Bell, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "MECHANIC", "DATA_ENTRY"] },
      { href: "/safety", label: "Safety", icon: ShieldAlert, roles: ["ADMIN", "GENERAL_MANAGER", "FLEET_MANAGER", "STATION_MANAGER", "MANAGER", "MECHANIC", "DATA_ENTRY"] },
